...
> The time-boxed trade-offs taken knowingly therefore all fell within the
> acceptable band, while the items posing the greatest risk arose without a
> decision being made. This supports a general observation: deliberate debt is
> more readily managed than debt incurred unintentionally, because a stated
> cause carries a stated resolution with it.
...
Section 11 (Maintenance and Future Evolution).
