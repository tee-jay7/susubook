...
Section 9 (Testing and Quality Assurance) rather than claimed as complete.
...
5. A test case exists in Section 9 (Testing and Quality Assurance) with a recorded actual result.
